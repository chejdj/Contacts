...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    self.navigationControll=[[UINavigationController alloc]initWithRootViewController:viewController];
    [self.navigationControll setNavigationBarHidden:YES animated:YES];
    self.window.rootViewController=_navigationControll;
